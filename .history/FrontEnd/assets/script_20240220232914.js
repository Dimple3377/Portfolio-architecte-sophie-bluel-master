...
function updateLoginLogoutButton() {
  ...
  if (sessionStorage.getItem("token")) {
    loginLogoutButton.onclick = handleLogout; // Associer la fonction de déconnexion au clic
  } else {
    loginLogoutButton.onclick = () => (window.location.href = "login.html"); // Redirection vers la page de connexion
  }
}
