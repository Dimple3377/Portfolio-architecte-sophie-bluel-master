...
function updateLoginLogoutButton() {
  const loginLogoutButton = document.getElementById("btnModifier"); // Assurez-vous d'avoir un bouton avec cet ID dans votre HTML
  if (sessionStorage.getItem("token")) {
    loginLogoutButton.textContent = "Déconnexion";
    ...
    loginLogoutButton.style.display = "none"; // Masquez ou affichez selon vos besoins initiaux pour la connexion
  }
}
