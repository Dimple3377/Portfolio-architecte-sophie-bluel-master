...
function initializeModal() {
  ...
  closeSpan.addEventListener("click", () => {
    ...
    document.querySelector("footer").style.display = "block"; // Réaffiche les mentions légales
  });
...
document.addEventListener("DOMContentLoaded", async () => {
  ...
  if (btnOpenAddPhoto) {
    btnOpenAddPhoto.addEventListener("click", function () {
      ...
      document.querySelector("footer").style.display = "none"; // Masque les mentions légales
