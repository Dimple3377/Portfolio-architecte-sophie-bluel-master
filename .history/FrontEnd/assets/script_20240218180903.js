...
// Modification pour ajuster le bouton Login/Logout
function adjustLoginLogoutButton(isLoggedIn = false) {
  const loginLogoutButton = document.getElementById("loginButton"); // Assurez-vous que cet ID correspond à votre élément dans le HTML
  if (isLoggedIn) {
    loginLogoutButton.textContent = "Logout";
    loginLogoutButton.href = "logout.html"; // Assurez-vous d'avoir une logique de déconnexion à cette URL
  } else {
    if (sessionStorage.getItem("token")) {
      loginLogoutButton.textContent = "Logout";
      loginLogoutButton.href = "logout.html"; // Ou exécutez la fonction de déconnexion ici
    } else {
